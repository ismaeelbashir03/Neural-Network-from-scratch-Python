...
class Model():
    ...
    def set(self, *, loss, optimizer, accuracy):
        ...
        # save our optimizer and loss functions locally
        self.loss = loss
    ...
    def train(self, X, real_y, *, epochs = 1, print_every=1, validation_data = None, batch_size = None):
        ...
        # here we get validation data if present and steps
        if validation_data != None:
            
            # we split our data as it is passed in as a tuple
        ...
        if batch_size is not None:
            ...
            # if we are using validation data
            if validation_data != None:

                # getting validation steps
